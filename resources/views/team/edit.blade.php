...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Modification de l'équipes</h1>
        </div>
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Equipes</h1>
        <p class="mb-4">Modification de {{ $team->name }}</p>
        <form action="{{ route('team.update', $team->id)}}" method="POST"
            ...
            <div class="input-group">
                <input type="text" name="name" class="form-control bg-light border small"
                       ...
                       value="{{ $team->name }}">
                <input type="hidden" name="worker_id" value='{{$team->id}}'>
